...
- [ ] On the next AI handoff, start by sharing [FABEL_CONTEXT.md](FABEL_CONTEXT.md).

## Tips

- One small commit per meaningful change keeps phone review easy.
- If a step feels heavy, simplify it; this system should stay light.
- Keep project notes free of private, medical, financial, account, password, or personal data.
